...
<nav class="nav-main cf" id="nav" role="navigation">
  ...
  <ul class="nav nav-right menu-items cf">
    ...
    <li class="is-hidden-on-mobile<?php e($page->uid() == 'made-with-kirby-and-love', ' is-active') ?>"><a class="red" title="Build an awesome website with Kirby!" href="<?php echo url('made-with-kirby-and-love') ?>">&#9829;</a></li>
